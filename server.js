...
setInterval(() => {
  http.get(`http://tinbot-123-n.glitch.me/`);
}, 280000);
...
client.on('message', wolf => {
  if (wolf.content === prefix + "hsef") {////هنا  الامر
let embed = new Discord.RichEmbed()
.setColor("BLUE")////لون الامبد
         .setDescription(`
[**Server Support.**](https://discord.gg/gJRVzsr)
 [**Invite Me.**](https://discord.com/api/oauth2/authorize?client_id=747949575934967808&permissions=8&scope=bot)
> البرفكس الخاص بالبوت هو [-]
الأوامر الخاصه بالبوت : 
            ・・・・・・・・・・・・・・・・・・
  👻***General orders***👻

> -ping | Show you bot ping.
> -tag | Beautiful and great speech display.
> -perms | It shows you your powers.
> -top-inv | View the highest invitations.
> -to-owner-bot | To communicate with the bot owner.
> -invite | Find out how many of your invitations.
> -avatar | Show you a avatar member.
> -avatar-server | show you avatar server.
...
> -عواصم I لعبة عواصم
> -نكت I البوت يعطيك نُكته`)////هنا الاوامر
.setFooter("Made By Musab || TinBot.")
...
> -server | Shows you information about the server
> -mvall,سحب الكل | Move all to your room
> -all-bots | show all the bots in your server.
> -move | Move member to a voice room
> -giveaway,قيف اواي | Creating giveaway
> -role,تفضل,رول @mention | To give role to a particular member. 
> -role all | To give role to everyone. 
> -role humans | لTo give role to all humans.
> -role bots | To give role to all bots.
> -status | The status of the members
> -clear,مسح <numbr> | clear chat
> -mute,اسكت @user <reason> | mute member
> -unmute,تكلم @user | unmute member
...
client.login("NzQ3OTQ5NTc1OTM0OTY3ODA4.X0WUUw.no1dRJDwTzhh1_yeJ2QGVV3cg7w");